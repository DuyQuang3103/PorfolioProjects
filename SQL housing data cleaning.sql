...
SELECT
PARSENAME(REPALCE(OwnerAddress,',','.'), 3)
...
Update Nashvillehouse
SET OwnerSplitAddress = PARSENAME(REPALCE(OwnerAddress,',','.'), 3);

ALTER TABLE NashvilleHouse
Add OwnerSplitCity Nvarchar(255);

Update Nashvillehouse
SET OwnerSplitCity = PARSENAME(REPALCE(OwnerAddress,',','.'), 2);

ALTER TABLE NashvilleHouse
Add OwnerSplitState Nvarchar(255);

Update Nashvillehouse
SET OwnerSplitState = PARSENAME(REPALCE(OwnerAddress,',','.'), 1);
